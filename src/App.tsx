...
import { Twitter, Send, Minus, Square, X } from 'lucide-react';
...
function App() {
  ...
  const triggerGlitchFlood = () => {
    ...
    const texts = Array.from({ length: 25 }, (_, i) => ({
      ...
      y: Math.random() * (window.innerHeight - 60), // Account for browser header
  ...
  return (
    <div className="min-h-screen bg-[#202124] font-mono">
      {/* Browser Header Bar */}
      <div className="bg-[#202124] border-b border-[#3c4043] h-12 flex items-center px-3 sticky top-0 z-40">
        {/* Browser Tab */}
        <div className="bg-[#35363a] rounded-t-lg px-4 py-2 flex items-center space-x-2 mr-2 min-w-0 max-w-xs">
          {/* Tiny T-Rex Icon */}
          <div className="tiny-trex-icon">
            <div className="flex flex-col gap-px">
              <div className="flex gap-px">
                <div className="w-px h-px bg-white"></div>
                <div className="w-px h-px bg-white"></div>
                <div className="w-px h-px bg-white"></div>
              </div>
              <div className="flex gap-px">
          ...
          <span className="text-[#e8eaed] text-sm truncate">No Connection</span>
        </div>
        
        {/* Address Bar */}
        <div className="flex-1 mx-4">
          <div className="bg-[#35363a] rounded-full px-4 py-1.5 max-w-md mx-auto">
            <span className="text-[#9aa0a6] text-sm font-mono">chrome://dino/</span>
          </div>
        </div>
        
        {/* Window Controls */}
        <div className="flex items-center space-x-2">
          <button className="text-[#5f6368] hover:bg-[#35363a] p-1.5 rounded">
            <Minus size={14} />
          </button>
          <button className="text-[#5f6368] hover:bg-[#35363a] p-1.5 rounded">
            <Square size={12} />
      ...
      <div className="min-h-[calc(100vh-48px)] bg-[#111111] text-white relative">
        {/* Glitch Flood Overlay */}
        {glitchActive && (
          <div className="fixed inset-0 pointer-events-none z-50" style={{ top: '48px' }}>
        ...
        {/* SECTION 1 - HERO */}
        <section className="min-h-[calc(100vh-48px)] flex flex-col items-center justify-center px-8 relative overflow-hidden">
          <div className="fade-section" style={{
            opacity: Math.max(0, 1 - scrollY / (window.innerHeight - 48))
          }}>
        ...
        {/* SECTION 2 - LORE */}
        <section className="min-h-[calc(100vh-48px)] flex items-center justify-center px-8">
          <div className="fade-section" style={{
            opacity: scrollY > (window.innerHeight - 48) * 0.5 && scrollY < (window.innerHeight - 48) * 1.5 ? 1 : 0,
        ...
        <section className="min-h-[calc(100vh-48px)] flex items-center justify-center px-8">
          <div className="fade-section" style={{
            opacity: scrollY > (window.innerHeight - 48) * 1.5 && scrollY < (window.innerHeight - 48) * 2.5 && !manifestoRevealed ? 1 : 0,
            transition: 'opacity 0.8s ease-in-out'
          }}>
        ...
        <section className="min-h-[calc(100vh-48px)] flex items-center justify-center px-8">
          <div className="fade-section" style={{
            opacity: manifestoRevealed || (scrollY > (window.innerHeight - 48) * 2.5 && scrollY < (window.innerHeight - 48) * 3.5) ? 1 : 0,
            transition: 'opacity 0.8s ease-in-out'
          }}>
        ...
        <section className="min-h-[calc(100vh-48px)] flex items-center justify-center px-8">
          <div className="fade-section" style={{
            opacity: scrollY > (window.innerHeight - 48) * 3.5 && scrollY < (window.innerHeight - 48) * 4.5 ? 1 : 0,
            transition: 'opacity 0.8s ease-in-out'
          }}>
        ...
        <section className="min-h-[calc(100vh-48px)] flex items-center justify-center px-8">
          <div className="fade-section" style={{
            opacity: scrollY > (window.innerHeight - 48) * 4.5 ? 1 : 0,
            transition: 'opacity 0.8s ease-in-out'
          }}>
            <div className="text-center">
